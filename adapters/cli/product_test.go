...
import (
	...
	"learning_hexagonal_architecture/adapters/cli"
...
func TestRun(t *testing.T) {
	...
	resultExpected := fmt.Sprintf("Product ID %s wit the name %s has been created with the price %f and status %s", productId, productName, productPrice, productStatus)
